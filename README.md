...
## [What is it?](https://youtu.be/1_45zRi992Q)
...
**IMPORTANT:** In order to use the code you must download [yolov5](https://github.com/ultralytics/yolov5) and place it in a /models sub repository inside the projects repository and place the images desired to be detected inside a /image repository. As seen in lines 111 and 113 in the code.
<img src="https://github.com/PolLopezPena/MechanicalTurk/assets/75804697/5c4e33e9-faed-4ab1-98be-df30554b37ae" alt="image" width="435
  "/>
